...
import { ReplaySubject, from, of, BehaviorSubject, Observable, throwError, timer, Subject, forkJoin, TimeoutError, map as map$1 } from 'rxjs';
...
TokenValidationService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.1.0", ngImport: i0, type: TokenValidationService, deps: [{ token: TokenHelperService }, { token: LoggerService }, { token: JwtWindowCryptoService }, { token: CryptoService }, { token: DOCUMENT }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.1.0", ngImport: i0, type: TokenValidationService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: TokenHelperService }, { type: LoggerService }, { type: JwtWindowCryptoService }, { type: CryptoService }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [DOCUMENT]
                }] }]; } });
...
class StsConfigHttpLoader {
    ...
    loadConfigs() {
        ...
        return singleConfigOrArray.pipe(map$1((value) => {
